"""
Hamiltonian Monte Carlo inference for the incoherent hardware photonic KAN.
"""
...
def run_hmc_inference() -> None:
    ...
    output_dir = Path(__file__).resolve().parent / "results" / "hardware_incoherent_hmc"
    ...
    plt.xlabel("x")
    plt.ylabel("y")
    plt.title("HMC posterior (HW incoherent photonic KAN)")
    plt.legend()
