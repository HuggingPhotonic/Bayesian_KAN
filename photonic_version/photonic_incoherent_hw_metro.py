"""
Metropolis MCMC inference for the incoherent hardware photonic KAN.
"""
...
def run_metropolis_inference() -> None:
    ...
    output_dir = Path(__file__).resolve().parent / "results" / "hardware_incoherent_mcmc"
    ...
    plt.xlabel("x")
    plt.ylabel("y")
    plt.title("Metropolis posterior (HW incoherent photonic KAN)")
    plt.legend()
