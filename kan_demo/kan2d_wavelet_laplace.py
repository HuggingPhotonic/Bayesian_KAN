"""
Wavelet KAN 2D Laplace approximation.
"""
...
OUTPUT_DIR = Path(__file__).parent / "results_laplace_wavelet_2d"
...
def run_experiment():
    ...
    print("Training MAP estimate with wavelet basis...")
    ...
    ax2.set_title("Laplace Mean (Wavelet)")
    ...
    plt.tight_layout()
    plt.savefig(OUTPUT_DIR / "wavelet_laplace_surfaces.png", dpi=150, bbox_inches="tight")
    ...
    plt.tight_layout()
    plt.savefig(OUTPUT_DIR / "wavelet_laplace_contours.png", dpi=150, bbox_inches="tight")
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print("Wavelet KAN 2D Laplace Approximation")
    print("=" * 60)
